...
var QiitaItems_1 = require('./QiitaItems')
var QiitaPresenter_1 = require('./QiitaPresenter')
var QiitaWidget = /** @class */ (function () {
  function QiitaWidget(container, conf) {
  ...
  QiitaWidget.prototype.init = function () {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, this.items.fetch()]
          case 1:
            _a.sent()
